...
const Login = () => {
    ...
    const {loginUserNormal} = useContext(FirebaseAuthContext);
    ...
    const handleFormSubmit = (e) => {
        ...
        loginUserNormal(email, password)
        .then(res => {
            ...
            if (isVerified === false) {
                ...
                .then(() => {
                    toast("Please verify your email. Check email, just sent.");
                })
                .catch(error => {
                    console.log(error);
                })
        ...
        <div className="flex flex-col items-center justify-center border-2 w-[60vw] mx-auto rounded-sm py-16 mt-8">
            ...
            <div className="flex flex-col gap-6 w-full px-16">
                ...
                <form onSubmit={handleFormSubmit} className="flex flex-col gap-y-6">
                    ...
                    <div>
                        <input type="submit" className="btn btn-warning w-full" value="Login" />
                    </div>
                </form>
